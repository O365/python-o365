...
class Account(object):
    ...
    def authenticate(self, *, scopes, **kwargs):
        ...
        :param scopes: list of protocol user scopes to be converted by
         the protocol
    ...
    def new_message(self, resource=None):
        ...
        :param resource: Custom resource to be used in this message.
    ...
    def address_book(self, *, resource=None, address_book='personal'):
        ...
        if address_book == 'personal':
            ...
            raise RuntimeError(
                'Addres_book must be either "personal" (resource address book) or "gal" (Global Address List)')
